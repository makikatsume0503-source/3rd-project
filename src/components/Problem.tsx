            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto relative">
                    ...
                    <motion.div
                        ...
                        className="bg-[#0c1829] rounded-xl p-8 shadow-xl border border-[#d4af37]/20 relative z-10"
                    >
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <p className="text-slate-300">24時間365日、ホームページが自動で新規顧客を獲得し続ける</p>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#d4af37] mt-2.5 flex-shrink-0"></span>
                                <p className="text-slate-300">価値観の合う「質の高いクライアント」だけを集められる</p>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#d4af37] mt-2.5 flex-shrink-0"></span>
                                <p className="text-slate-300">信頼度・専門性が可視化され、"あなただから"と選ばれる</p>
                            </li>
                        </ul>
                    </motion.div>
                </div>
